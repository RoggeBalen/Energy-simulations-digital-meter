...
### Load data
#------------
rogge <- read.csv2("~/Energy-simulations-digital-meter/data/Rogge_14022026.csv")
rogge <- na.omit(rogge)


### Change format
#----------------
df_rogge <- Change_data_format(rogge , tz = "Europe/Brussels")
```
...
out_rogge <- rbind(
  ...
  simulate_battery(df_rogge, batt_cap = 0, tarief = "Variabel tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
  simulate_battery(df_rogge, batt_cap = 1, tarief = "Vast tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
  simulate_battery(df_rogge, batt_cap = 1, tarief = "Variabel tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
  simulate_battery(df_rogge, batt_cap = 3, tarief = "Vast tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
...
### Make the plot
#----------------
plot_week_switch_batt(out_rogge , tz_display = "Europe/Brussels")
```
...
### Make the plot
#----------------
out_rogge_subset <- out_rogge %>% filter(Type != 0)
plot_week_switch_batt_cap(out_rogge_subset , tz_display = "Europe/Brussels")
```
...
out_leo <- rbind(
  ...
  simulate_battery(df_leo, batt_cap = 0, tarief = "Variabel tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
  simulate_battery(df_leo, batt_cap = 1, tarief = "Vast tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
  simulate_battery(df_leo, batt_cap = 1, tarief = "Variabel tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
  simulate_battery(df_leo, batt_cap = 3, tarief = "Vast tarief ecopower Kempen", energie_kost = energy_cost_ecopower),
...
### Make the plot
#----------------
out_leo_subset <- out_leo  %>% filter(Type != 0)
plot_week_switch_batt_cap(out_leo_subset , tz_display = "Europe/Brussels")
```
